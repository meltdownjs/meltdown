...
const UserInfiniteMultiSelect = () => {
  const {
    ...
    getItemProps,
    options,
  } = useInfiniteMultiSelect<PaginatedList<User>, User, HTMLDivElement>({
...
describe('useInfiniteSelect', () => {
  ...
  it('should render an infinite mutli select component with users as options', async () => {
    const user = userEvent.setup()
    renderWithQueryClient(<UserInfiniteMultiSelect />)
